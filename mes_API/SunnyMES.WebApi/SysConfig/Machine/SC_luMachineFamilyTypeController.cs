...
namespace SunnyMES.WebApi.SysConfig.Machine
{
    ...
    [ApiVersion("3.0")]
    public class SC_luMachineFamilyTypeController : AreaApiControllerCustom<SC_luMachineFamilyType, SC_luMachineFamilyType, SC_luMachineFamilyType, ISC_luMachineFamilyTypeServices, string>
    {
        public SC_luMachineFamilyTypeController(ISC_luMachineFamilyTypeServices services) : base(services)
        {
        ...
        [YuebonAuthorize("")]
        public override async  Task<IActionResult> UpdateAsync(SC_luMachineFamilyType inInfo)
        {
            ...
            string tmpWhere = OutputExtensions.FormartWhere<SC_luMachineFamilyType>(inInfo, PrimaryKeyName);
        ...
        [YuebonAuthorize("")]
        public async Task<IActionResult> FindWithPagerSearchAsync(SearchMachineFamilyTypeInputDto search)
        {
            CommonResult commonResult = new CommonResult();
