...
namespace SunnyMES.WebApi.Areas.Security.Controllers
{
    ...
    [ApiVersion("3.0")]
    public class SC_LabelFamilyController : AreaApiControllerReport<ISC_IdNameDescService, string>
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        /// <param name="_iService"></param>
        public SC_LabelFamilyController(ISC_IdNameDescService _iService) : base(_iService)
        {
            iService = _iService;
        }
        ...
        /// Insert
        /// </summary>
        /// <param name="v_SC_IdNameDescDto"></param>
        /// <returns></returns>
        [HttpPost("Insert")]
        [YuebonAuthorize("")]
        [AllowAnonymous]
        public async Task<IActionResult> Insert(SC_IdNameDesc v_SC_IdNameDescDto)
        {
            CommonResult v_ComResult = new CommonResult();
            try
            {
                ...
                string list = await iService.Insert(v_SC_IdNameDescDto, "luLabelFamily", trans);
        ...
        public async Task<IActionResult> Delete(string Id)
        {
            ...
            try
            {
                ...
                List<TabVal> List_ConfInfo = await iService.GetConfInfo(P_Language, P_LineID, P_StationID, P_EmployeeID, P_CurrentLoginIP);
                IDbTransaction trans = null;
                string list = await iService.Delete(Id, "luLabelFamily", trans);
        ...
        [YuebonAuthorize("")]
        [AllowAnonymous]
        public async Task<IActionResult> Update(SC_IdNameDesc v_SC_IdNameDescDto)
        {
            CommonResult v_ComResult = new CommonResult();
            try
            {
                ...
                List<TabVal> List_ConfInfo = await iService.GetConfInfo(P_Language, P_LineID, P_StationID, P_EmployeeID, P_CurrentLoginIP);
                IDbTransaction trans = null;
                string list = await iService.Update(v_SC_IdNameDescDto, "luLabelFamily", trans);
        ...
        [YuebonAuthorize("")]
        [AllowAnonymous]
        public async Task<IActionResult> Clone(SC_IdNameDesc v_SC_IdNameDescDto)
        {
            CommonResult v_ComResult = new CommonResult();
            try
            {
                ...
                List<TabVal> List_ConfInfo = await iService.GetConfInfo(P_Language, P_LineID, P_StationID, P_EmployeeID, P_CurrentLoginIP);
                IDbTransaction trans = null;
                string list = await iService.Clone(v_SC_IdNameDescDto, "luLabelFamily", trans);
        ...
        /// <param name="LikeQuery">模糊查询字段 文本类型 Name  Description </param>        
            ...
            )
        {
            ...
            CommonResult<PageResult<SC_IdNameDesc>> v_ComResult = new CommonResult<PageResult<SC_IdNameDesc>>();
            try
            {
                SC_IdNameDescSearch search = new SC_IdNameDescSearch();
                ...
                PageResult<SC_IdNameDesc> list = await iService.FindWithPagerSearchAsync(search, "luLabelFamily");
