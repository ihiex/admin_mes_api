...
{
    /// <summary>
    ///  SC_mesLabelFieldDefinition 可用接口
    /// </summary>
    [ApiController]
    [Route("api/SysConfig/[controller]")]
    [ApiVersion("3.0")]
    public class SC_mesLabelFieldDefinitionController : AreaApiControllerReport<ISC_mesLabelFieldDefinitionService, string>
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        /// <param name="_iService"></param>
        public SC_mesLabelFieldDefinitionController(ISC_mesLabelFieldDefinitionService _iService) : base(_iService)
        {
            iService = _iService;
        }
        ...
        /// Insert
        /// </summary>
        /// <param name="v_SC_mesLabelFieldDefinition"></param>
        /// <returns></returns>
        [HttpPost("Insert")]
        [YuebonAuthorize("")]
        [AllowAnonymous]
        public async Task<IActionResult> Insert(SC_mesLabelFieldDefinition v_SC_mesLabelFieldDefinition)
        {
            CommonResult v_ComResult = new CommonResult();
            try
            {
                ...
                string list = await iService.Insert(v_SC_mesLabelFieldDefinition, trans);
        ...
        [YuebonAuthorize("")]
        [AllowAnonymous]
        public async Task<IActionResult> Update(SC_mesLabelFieldDefinition v_SC_mesLabelFieldDefinition)
        {
            CommonResult v_ComResult = new CommonResult();
            try
            {
                ...
                List<TabVal> List_ConfInfo = await iService.GetConfInfo(P_Language, P_LineID, P_StationID, P_EmployeeID, P_CurrentLoginIP);
                IDbTransaction trans = null;
                string list = await iService.Update(v_SC_mesLabelFieldDefinition, trans);
        ...
        [YuebonAuthorize("")]
        [AllowAnonymous]
        public async Task<IActionResult> Clone(SC_mesLabelFieldDefinition v_SC_mesLabelFieldDefinition)
        {
            CommonResult v_ComResult = new CommonResult();
            try
            {
                ...
                List<TabVal> List_ConfInfo = await iService.GetConfInfo(P_Language, P_LineID, P_StationID, P_EmployeeID, P_CurrentLoginIP);
                IDbTransaction trans = null;
                string list = await iService.Clone(v_SC_mesLabelFieldDefinition, trans);
            ...
            )
        {
            ...
            CommonResult<PageResult<SC_mesLabelFieldDefinition>> v_ComResult = new CommonResult<PageResult<SC_mesLabelFieldDefinition>>();

            try
            {
                SC_mesLabelFieldDefinitionSearch search = new SC_mesLabelFieldDefinitionSearch();
                ...
                PageResult<SC_mesLabelFieldDefinition> list = await iService.FindWithPagerMyAsync(search);
