...
namespace SunnyMES.WebApi.SysConfig.Part
{
    ...
    [ApiVersion("3.0")]
    public class SC_mesPartFamilyDetailController : AreaApiControllerCustom<SC_mesPartFamilyDetail, SC_mesPartFamilyDetail, SC_mesPartFamilyDetail, ISC_mesPartFamilyDetailServices, string>
    {
        public SC_mesPartFamilyDetailController(ISC_mesPartFamilyDetailServices services): base(services)
        {
        ...
        [YuebonAuthorize("")]
        public override async  Task<IActionResult> UpdateAsync(SC_mesPartFamilyDetail inInfo)
        {
            ...
            if (beforData.PartFamilyDetailDefID != inInfo.PartFamilyDetailDefID)
