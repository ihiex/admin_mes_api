...
namespace SunnyMES.WebApi.SysConfig.Part
{
    ...
    [ApiVersion("3.0")]
    public class SC_luPartFamilyDetailDefController : AreaApiControllerCustom<SC_luPartFamilyDetailDef, SC_luPartFamilyDetailDef, SC_luPartFamilyDetailDef, ISC_luPartFamilyDetailDefServices, string>
    {
        public SC_luPartFamilyDetailDefController(ISC_luPartFamilyDetailDefServices _iService) : base(_iService)
        {
        ...
        [YuebonAuthorize("")]
        public override async  Task<IActionResult> UpdateAsync(SC_luPartFamilyDetailDef inInfo)
        {
