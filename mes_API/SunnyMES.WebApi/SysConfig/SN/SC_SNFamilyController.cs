...
namespace SunnyMES.WebApi.Areas.Security.Controllers
{
    ...
    [ApiVersion("3.0")]
    public class SC_SNFamilyController : AreaApiControllerReport<ISC_IdNameDescService, string>
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        /// <param name="_iService"></param>
        public SC_SNFamilyController(ISC_IdNameDescService _iService) : base(_iService)
        {
            iService = _iService;
        }
        ...
        public async Task<IActionResult> Insert(SC_IdNameDesc v_SC_IdNameDescDto)
        {
            ...
            try
            {
                ...
                string list = await iService.Insert(v_SC_IdNameDescDto, "luSNFamily", trans);
        ...
        public async Task<IActionResult> Delete(string Id)
        {
            ...
            try
            {
                ...
                List<TabVal> List_ConfInfo = await iService.GetConfInfo(P_Language, P_LineID, P_StationID, P_EmployeeID, P_CurrentLoginIP);
                IDbTransaction trans = null;
                string list = await iService.Delete(Id, "luSNFamily", trans);
        ...
        public async Task<IActionResult> Update(SC_IdNameDesc v_SC_IdNameDescDto)
        {
            ...
            try
            {
                ...
                List<TabVal> List_ConfInfo = await iService.GetConfInfo(P_Language, P_LineID, P_StationID, P_EmployeeID, P_CurrentLoginIP);
                IDbTransaction trans = null;
                string list = await iService.Update(v_SC_IdNameDescDto, "luSNFamily", trans);
        ...
        public async Task<IActionResult> Clone(SC_IdNameDesc v_SC_IdNameDescDto)
        {
            ...
            try
            {
                ...
                List<TabVal> List_ConfInfo = await iService.GetConfInfo(P_Language, P_LineID, P_StationID, P_EmployeeID, P_CurrentLoginIP);
                IDbTransaction trans = null;
                string list = await iService.Clone(v_SC_IdNameDescDto, "luSNFamily", trans);
            ...
            )
        {
            ...
            try
            {
                ...
                PageResult<SC_IdNameDesc> list = await iService.FindWithPagerSearchAsync(search, "luSNFamily");
