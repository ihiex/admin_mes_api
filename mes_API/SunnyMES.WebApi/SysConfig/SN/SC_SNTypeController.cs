...
namespace SunnyMES.WebApi.Areas.Security.Controllers
{
    ...
    [ApiVersion("3.0")]
    public class SC_SNTypeController : AreaApiControllerReport<ISC_IdDescService, string>
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        /// <param name="_iService"></param>
        public SC_SNTypeController(ISC_IdDescService _iService) : base(_iService)
        {
            iService = _iService;
        }
        ...
        /// Insert
        /// </summary>
        /// <param name="v_SC_IdDescDto"></param>
        /// <returns></returns>
        [HttpPost("Insert")]
        [YuebonAuthorize("")]
        [AllowAnonymous]
        public async Task<IActionResult> Insert(SC_IdDesc v_SC_IdDescDto)
        {
            CommonResult v_ComResult = new CommonResult();
            try
            {
                ...
                string list = await iService.Insert(v_SC_IdDescDto, "luSerialNumberType", trans);
        ...
        public async Task<IActionResult> Delete(string Id)
        {
            ...
            try
            {
                ...
                List<TabVal> List_ConfInfo = await iService.GetConfInfo(P_Language, P_LineID, P_StationID, P_EmployeeID, P_CurrentLoginIP);
                IDbTransaction trans = null;
                string list = await iService.Delete(Id, "luSerialNumberType", trans);
        ...
        [YuebonAuthorize("")]
        [AllowAnonymous]
        public async Task<IActionResult> Update(SC_IdDesc v_SC_IdDescDto)
        {
            CommonResult v_ComResult = new CommonResult();
            try
            {
                ...
                List<TabVal> List_ConfInfo = await iService.GetConfInfo(P_Language, P_LineID, P_StationID, P_EmployeeID, P_CurrentLoginIP);
                IDbTransaction trans = null;
                string list = await iService.Update(v_SC_IdDescDto, "luSerialNumberType", trans);
        ...
        [YuebonAuthorize("")]
        [AllowAnonymous]
        public async Task<IActionResult> Clone(SC_IdDesc v_SC_IdDescDto)
        {
            CommonResult v_ComResult = new CommonResult();
            try
            {
                ...
                List<TabVal> List_ConfInfo = await iService.GetConfInfo(P_Language, P_LineID, P_StationID, P_EmployeeID, P_CurrentLoginIP);
                IDbTransaction trans = null;
                string list = await iService.Clone(v_SC_IdDescDto, "luSerialNumberType", trans);
            ...
            )
        {
            ...
            CommonResult<PageResult<SC_IdDesc>> v_ComResult = new CommonResult<PageResult<SC_IdDesc>>();
            try
            {
                SC_IdDescSearch search = new SC_IdDescSearch();
                ...
                PageResult<SC_IdDesc> list = await iService.FindWithPagerSearchAsync(search, "luSerialNumberType");
