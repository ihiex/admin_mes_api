...
{
    /// <summary>
    ///  SC_mesStationTypeAccess 可用接口
    /// </summary>
    [ApiController]
    [Route("api/SysConfig/[controller]")]
    [ApiVersion("3.0")]
    public class SC_mesStationTypeAccessController : AreaApiControllerReport<ISC_mesStationTypeAccessService, string>
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        /// <param name="_iService"></param>
        public SC_mesStationTypeAccessController(ISC_mesStationTypeAccessService _iService) : base(_iService)
        {
            iService = _iService;
        }
        ...
        /// Insert
        /// </summary>
        /// <param name="v_SC_mesStationTypeAccess"></param>
        /// <returns></returns>
        [HttpPost("Insert")]
        [YuebonAuthorize("")]
        [AllowAnonymous]
        public async Task<IActionResult> Insert(SC_mesStationTypeAccess v_SC_mesStationTypeAccess)
        {
            CommonResult v_ComResult = new CommonResult();
            try
            {
                ...
                string list = await iService.Insert(v_SC_mesStationTypeAccess, trans);
        ...
        [YuebonAuthorize("")]
        [AllowAnonymous]
        public async Task<IActionResult> Update(SC_mesStationTypeAccess v_SC_mesStationTypeAccess)
        {
            CommonResult v_ComResult = new CommonResult();
            try
            {
                ...
                List<TabVal> List_ConfInfo = await iService.GetConfInfo(P_Language, P_LineID, P_StationID, P_EmployeeID, P_CurrentLoginIP);
                IDbTransaction trans = null;
                string list = await iService.Update(v_SC_mesStationTypeAccess, trans);
        ...
        [YuebonAuthorize("")]
        [AllowAnonymous]
        public async Task<IActionResult> Clone(SC_mesStationTypeAccess v_SC_mesStationTypeAccess)
        {
            CommonResult v_ComResult = new CommonResult();
            try
            {
                ...
                List<TabVal> List_ConfInfo = await iService.GetConfInfo(P_Language, P_LineID, P_StationID, P_EmployeeID, P_CurrentLoginIP);
                IDbTransaction trans = null;
                string list = await iService.Clone(v_SC_mesStationTypeAccess, trans);
            ...
            )
        {
            ...
            CommonResult<PageResult<SC_mesStationTypeAccessDto>> v_ComResult = new CommonResult<PageResult<SC_mesStationTypeAccessDto>>();

            try
            {
                SC_mesStationTypeAccessSearch search = new SC_mesStationTypeAccessSearch();
                ...
                PageResult<SC_mesStationTypeAccessDto> list = await iService.FindWithPagerMyAsync(search);
