...
namespace SunnyMES.WebApi.Areas.Security.Controllers
{
    ...
    [ApiVersion("2.0")]
    public class PrintController : AreaApiControllerReport<IPrintService, string>
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        /// <param name="_iService"></param>
        public PrintController(IPrintService _iService) : base(_iService)
        {
            iService = _iService;
        }
        ...
        /// <returns></returns>
        [HttpGet("mesLineGroup")]
        [YuebonAuthorize("")]
        [AllowAnonymousAttribute]
        public async Task<IActionResult> mesLineGroup(string LineType, int PartFamilyTypeID)
        {
            //ReportCache();
            CommonResult result = new CommonResult();
            try
            {
                IEnumerable<dynamic> list = await iService.mesLineGroup(LineType, PartFamilyTypeID);
                result.Success = true;
        ...
        /// <param name="Type">FG,UPC,FG_DOE,FG_NPI,FG_DOENew</param>   
            ...
            string S_PartID, string S_POID,string S_LineNumber, string S_UnitStatus,string Type, string S_URL)
        {
            ...
            try
            {
                ...
                ConfirmPOOutputDto List_Dyn = await iService.SetConfirmPO(S_PartFamilyTypeID, S_PartFamilyID,
                    S_PartID, S_POID, S_LineNumber, S_UnitStatus, Type, S_URL);
        ...
        /// <summary>
        /// 生成 FG,UPC,FG_DOE,FG_NPI,FG_DOENew 并打印
        /// </summary>
        /// <param name="S_PartFamilyTypeID">料号组类别</param>
        /// <param name="S_PartFamilyID">料号组</param>
        /// <param name="S_PartID">料号</param>
        /// <param name="S_POID">工单</param>
        /// <param name="I_QTY">数量</param>
        /// <param name="S_LineNumber">线号</param>
        /// <param name="S_URL">URL</param>
        /// <param name="ET">ET</param>
        /// <param name="SPAC">SPAC</param>
        /// <param name="B">B FG_DOENew</param>
        /// <param name="PP">PP FG_DOENew</param>
        /// <param name="PredictQTY">PredictQTY FG_DOENew</param>
        /// <param name="Type">FG,UPC,FG_DOE,FG_NPI,FG_DOENew</param>           
        /// <returns></returns>
        [HttpGet("CreateSN")]
        [YuebonAuthorize("")]
        [AllowAnonymousAttribute]
        public async Task<IActionResult> CreateSN(string S_PartFamilyTypeID, string S_PartFamilyID,
            string S_PartID, string S_POID, int I_QTY, string S_LineNumber,string S_URL,
            ...
            string Type)
        {
            ...
            try
            {
                ...
                ConfirmPOOutputDto v_ConfirmPOOutputDto = await iService.SetConfirmPO(S_PartFamilyTypeID,
                    S_PartFamilyID, S_PartID, S_POID, S_LineNumber, "1", Type, S_URL);

                CreateSNOutputDto List_Dyn = await iService.CreateSN(S_PartFamilyTypeID, S_PartFamilyID, S_PartID,
                    S_POID, I_QTY, S_LineNumber, v_ConfirmPOOutputDto,  
                    ET,  SPAC,
                     B,  PP,  PredictQTY,
                    Type);
