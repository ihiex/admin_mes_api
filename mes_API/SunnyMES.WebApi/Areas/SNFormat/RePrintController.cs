...
namespace SunnyMES.WebApi.Areas.Security.Controllers
{
    ...
    [ApiVersion("2.0")]
    public class RePrintController : AreaApiControllerReport<IRePrintService, string>
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        /// <param name="_iService"></param>
        public RePrintController(IRePrintService _iService) : base(_iService)
        {
            iService = _iService;
        }
            ...
            string S_PartID, string S_POID, string S_UnitStatus, string Type, string S_URL)
        {
            ...
            try
            {
                ...
                ConfirmPOOutputDto List_Dyn = await iService.SetConfirmPO(S_PartFamilyTypeID, S_PartFamilyID,
                    S_PartID, S_POID, S_UnitStatus, Type, S_URL);
                    ...
                    string S_PartID, string S_POID, string S_UnitStatus,string Type, string S_URL)
        {
            ...
            try
            {
                ...
                ConfirmPOOutputDto v_ConfirmPOOutputDto = await iService.SetConfirmPO(S_PartFamilyTypeID,
                    S_PartFamilyID, S_PartID, S_POID, S_UnitStatus,Type, S_URL);

                CreateSNOutputDto List_Dyn = await iService.SetScanSN(S_SN, S_PartFamilyTypeID, S_PartFamilyID, S_PartID,
                    S_POID, S_UnitStatus,Type, v_ConfirmPOOutputDto);
