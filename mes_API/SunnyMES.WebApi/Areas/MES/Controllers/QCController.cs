...
namespace SunnyMES.WebApi.Areas.MES.Controllers
{
    ...
    [ApiVersion("2.0")]
    public class QCController : AreaApiControllerReport<SunnyMES.Security.IServices.IQCServices, string>
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        /// <param name="_iService"></param>
        public QCController(SunnyMES.Security.IServices.IQCServices _iService) : base(_iService)
        {
            iService = _iService;
        }
