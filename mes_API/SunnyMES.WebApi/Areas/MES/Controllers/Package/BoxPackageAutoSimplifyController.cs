...
namespace SunnyMES.WebApi.Areas.MES.Controllers
{
    ...
    [ApiVersion("2.0")]
    public class BoxPackageAutoSimplifyController : AreaApiControllerCommon<IBoxPackageAutoSimplifyServices,string>
    {
        private readonly IBoxPackageAutoSimplifyServices iService;

        /// <summary>
        /// 
        /// </summary>
        /// <param name="_iService"></param>
        public BoxPackageAutoSimplifyController(IBoxPackageAutoSimplifyServices _iService) : base(_iService)
        {
            iService = _iService;
        }
