...
namespace SunnyMES.AspNetCore.Controllers
{
    ...
    [ApiController]
    public abstract class AreaApiControllerGeneric<T, TODto, TIDto, TService, TKey> : ApiController
        where T : EntityGeneric
        where TService : IServiceGeneric<T, TODto, TKey>
        where TODto : class
        where TIDto : class
        where TKey : IEquatable<TKey>
    {
        ...
        public AreaApiControllerGeneric(TService _iService)
        {
            iService = _iService;
        }
