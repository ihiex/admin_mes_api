...
{
    public class QCServices : BaseServiceReport<string>, IServices.IQCServices
    {
        private readonly IQCRepository _repository;
        private readonly ILogService _logService;

        public QCServices(IQCRepository repository, ILogService logService) : base(repository)
        {
