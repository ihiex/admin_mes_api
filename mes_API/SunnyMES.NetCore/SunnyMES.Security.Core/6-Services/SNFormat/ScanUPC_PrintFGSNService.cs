...
{
    public class ScanUPC_PrintFGSNService : BaseServiceReport<string>, IScanUPC_PrintFGSNService
    {
        private readonly IScanUPC_PrintFGSNRepository _repository;
        private readonly ILogService _logService;

        public ScanUPC_PrintFGSNService(IScanUPC_PrintFGSNRepository repository, ILogService logService) : base(repository)
        {
            ...
            string S_PartID, string S_POID, ConfirmPOOutputDto v_ConfirmPOOutputDto)
        {
            return await _repository.SetScanSN(S_SN, S_PartFamilyTypeID, S_PartFamilyID,
             S_PartID, S_POID, v_ConfirmPOOutputDto);
        }
