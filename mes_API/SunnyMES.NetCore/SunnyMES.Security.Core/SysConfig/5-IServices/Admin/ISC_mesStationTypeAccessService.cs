...
{
    public interface ISC_mesStationTypeAccessService : IServiceReport<string>
    {
        ...
        Task<PageResult<SC_mesStationTypeAccessDto>> FindWithPagerMyAsync(SC_mesStationTypeAccessSearch search);
