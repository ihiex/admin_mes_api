...
{
    public interface ISC_mesStationService : IServiceReport<string>
    {
        ...
        Task<string> Update(SC_mesStation v_SC_mesStationConfigSettingDto, IDbTransaction trans = null);

        Task<string> Clone(SC_mesStation v_SC_mesStationConfigSettingDto, IDbTransaction trans = null);
        Task<PageResult<SC_mesStationALLDto>> FindWithPagerSearchAsync(SC_mesStationSearch search);
