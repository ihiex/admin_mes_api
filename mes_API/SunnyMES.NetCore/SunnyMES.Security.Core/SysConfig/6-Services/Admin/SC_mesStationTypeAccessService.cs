...
{
    public class SC_mesStationTypeAccessService : BaseServiceReport<string>, ISC_mesStationTypeAccessService
    {
        private readonly ISC_mesStationTypeAccessRepository _repository;
        private readonly ILogService _logService;

        public SC_mesStationTypeAccessService(ISC_mesStationTypeAccessRepository repository, ILogService logService) : base(repository)
        {
        ...
        {
            return await _repository.Insert(v_SC_mesStationTypeAccess, trans);
        }
        ...
        {
            return await _repository.Update(v_SC_mesStationTypeAccess, trans);
        }

        public async Task<string> Clone(SC_mesStationTypeAccess v_SC_mesStationTypeAccess, IDbTransaction trans = null)
        {
            return await _repository.Clone(v_SC_mesStationTypeAccess, trans);
        }
        ...
        public async Task<PageResult<SC_mesStationTypeAccessDto>> FindWithPagerMyAsync(SC_mesStationTypeAccessSearch search)
        {
            ...
            List<SC_mesStationTypeAccessDto> list = await _repository.FindWithPagerMyAsync(search, pagerInfo);
            ...
            PageResult<SC_mesStationTypeAccessDto> pageResult = new PageResult<SC_mesStationTypeAccessDto>
            {
