...
{
    public class SC_mesRouteService : BaseServiceReport<string>, ISC_mesRouteService
    {
        private readonly ISC_mesRouteRepository _repository;
        private readonly ILogService _logService;

        public SC_mesRouteService(ISC_mesRouteRepository repository, ILogService logService) : base(repository)
        {
        ...
        {
            return await _repository.Insert(v_SC_mesRoute, trans);
        }
        ...
        {
            return await _repository.Update(v_SC_mesRoute, trans);
        }

        public async Task<string> Clone(SC_mesRoute v_SC_mesRoute, IDbTransaction trans = null)
        {
            return await _repository.Clone(v_SC_mesRoute, trans);
        }
        ...
        public async Task<PageResult<SC_mesRouteDto>> FindWithPagerMyAsync(SC_mesRouteSearch search)
        {
            ...
            List<SC_mesRouteDto> list = await _repository.FindWithPagerMyAsync(search, pagerInfo);
            ...
            PageResult<SC_mesRouteDto> pageResult = new PageResult<SC_mesRouteDto>
            {
