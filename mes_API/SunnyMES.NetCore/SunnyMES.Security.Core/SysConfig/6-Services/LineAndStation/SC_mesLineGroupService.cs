...
{
    public class SC_mesLineGroupService : BaseServiceReport<string>, ISC_mesLineGroupService
    {
        private readonly ISC_mesLineGroupRepository _repository;
        private readonly ILogService _logService;

        public SC_mesLineGroupService(ISC_mesLineGroupRepository repository, ILogService logService) : base(repository)
        {
        ...
        {
            return await _repository.Insert(v_SC_mesLineGroupDto, trans);
        }
        ...
        {
            return await _repository.Update(v_SC_mesLineGroupDto, trans);
        }

        public async Task<string> Clone(SC_mesLineGroupDto v_SC_mesLineGroupDto, IDbTransaction trans = null)
        {
            return await _repository.Clone(v_SC_mesLineGroupDto, trans);
        }
        ...
        public async Task<PageResult<SC_mesLineGroupSearch>> FindWithPagerMyAsync(SC_mesLineGroupSearch search)
        {
            ...
            List<SC_mesLineGroupSearch> list = await _repository.FindWithPagerMyAsync(search, pagerInfo);
            ...
            PageResult<SC_mesLineGroupSearch> pageResult = new PageResult<SC_mesLineGroupSearch>
            {
