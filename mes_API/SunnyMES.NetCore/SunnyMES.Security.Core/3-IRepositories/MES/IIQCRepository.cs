...
{
    public interface IIQCRepository : IRepositoryReport<string>
    {
        ...
        Task<SetScanSNOutputDto> SetScanChildSN(string S_SN, string S_ChildSN, string S_PartFamilyTypeID, string S_PartFamilyID,
            string S_PartID, string S_POID, string S_UnitStatus, string S_DefectID, string S_InnerSN_Pattern, string S_URL);
    }
}