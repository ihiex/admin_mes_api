...
namespace SunnyMES.Commons
{
    ...
    public static class UIConstants
    {
        ...
        /// 版权信息
        /// </summary>
        public static string CopyRight= string.Format("<strong>Copyright &copy; 2017-{0} <a href=\"http://www.SunnyMES.com\" target=\"_blank\">Yuebon Tech</a>.</strong>", DateTime.Now.Year);
        /// <summary>
        /// Web验证地址
        /// </summary>
        public static string WebRegisterURL = "http://www.SunnyMES.com/WebRegister.aspx";
