...
namespace SunnyMES.Commons.DbContextCore
{
    ...
    /// DbContext上下文的实现
    /// </summary>
    public class BaseDbContextGeneric : DbContext, IDbContextCoreGeneric
    {
        ...
        /// 
        /// </summary>
        protected BaseDbContextGeneric()
        {
        ...
        public BaseDbContextGeneric(DbConnectionOptions dbConnectionOptions)
        {
        ...
        /// <returns></returns>
        public virtual int Delete<T, TKey>(TKey key) where T : EntityGeneric
        {
        ...
        /// <param name="key"></param>
        /// <returns></returns>
        public virtual T Find<T, TKey>(TKey key) where T : EntityGeneric
        {
            return base.Find<T>(key);
        }
        /// <summary>
        ...
        /// <param name="key"></param>
        /// <returns></returns>
        public virtual async Task<T> FindAsync<T, TKey>(TKey key) where T : EntityGeneric
        {
            return await base.FindAsync<T>(key);
        }
        /// <summary>
        ...
        /// <returns></returns>
        public T GetByCompileQuery<T, TKey>(TKey id) where T : EntityGeneric
        {
        ...
        /// <param name="id">主键值</param>
        /// <returns></returns>
        public Task<T> GetByCompileQueryAsync<T, TKey>(TKey id) where T : EntityGeneric
        {
