...
namespace SunnyMES.Commons.DbContextCore
{
    ...
    /// DbContext上下文的实现
    /// </summary>
    public  class BaseDbContextCustom : DbContext, IDbContextCoreCustom
    {
        ...
        public BaseDbContextCustom(DbConnectionOptions dbConnectionOptions)
        {
