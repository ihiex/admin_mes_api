...
namespace SunnyMES.Commons.Repositories
{
    ...
    public abstract class BaseRepositoryGeneric<T, TKey> : IRepositoryGeneric<T, TKey>, ITransientDependency
        where T : EntityGeneric
    {
        /// <summary>
        /// 数据库超时(10分)  600000 秒
        /// </summary>
        ...
        ///  EF DBContext
        /// </summary>
        public IDbContextCoreGeneric _dbContext;
        ...
        public BaseRepositoryGeneric(IDbContextCoreGeneric dbContext)
        {
        ...
        public BaseRepositoryGeneric(IDbContextFactory dbContextFactory)
        {
        ...
        public virtual List<T> FindWithPager(string condition, PagerInfo info, string fieldToSort, bool desc, IDbTransaction trans = null)
        {
            ...
            PagerHelperGeneric pagerHelper = new PagerHelperGeneric(this.tableName, this.selectedFields, fieldToSort, info.PageSize, info.CurrentPageIndex, desc, condition);
        ...
        /// EF 上下文接口，可读可写
        /// </summary>
        public virtual IDbContextCoreGeneric DbContext
        {
