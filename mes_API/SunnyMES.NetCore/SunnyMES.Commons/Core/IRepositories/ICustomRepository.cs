...
namespace SunnyMES.Commons.IRepositories
{
    /// <summary>
    ...
    public interface ICustomRepository<T, TKey> : IDisposable where T : Entity
    {

        void SetCommonHeader(CommonHeader  commonHeader);
        IDbTransaction GetDbTran();
        #region dapper 操作
        ...
        /// <returns></returns>
        Task<long> UpdateAsync2(T entity, TKey primaryKey, IDbTransaction trans = null);
        ...
        /// <returns></returns>
        Task<IEnumerable<T>> FindWithAllPagerAsync(PageCustomInfo pageCustomInfo);
        /// <summary>
        /// 根据条件查询数据库,并返回对象集合(用于分页数据显示)
        /// </summary>
        /// <param name="condition">查询的条件</param>
        ...
        /// <param name="trans"></param>
        /// <returns></returns>
        Task<List<T>> FindWithPagerCustomSqlAsync(string sql, PagerInfo info, string fieldToSort, bool desc, IDbTransaction trans = null);
        /// <summary>
        /// 通过sql语句查询自定义类型
        /// </summary>
        ...
        /// <param name="trans"></param>
        /// <returns></returns>
        Task<List<W>> FindWithPagerCustomSqlAsync<W>(string sql, PagerInfo info, string fieldToSort, bool desc, IDbTransaction trans = null);
        List<W> FindWithPagerCustomSql<W>(string sql, PagerInfo info, string fieldToSort, bool desc, IDbTransaction trans = null);
        /// <summary>
