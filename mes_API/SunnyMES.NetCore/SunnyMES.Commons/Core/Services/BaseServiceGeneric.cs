...
namespace SunnyMES.Commons.Services
{
    ...
    public abstract class BaseServiceGeneric<T, TODto, TKey> : IServiceGeneric<T, TODto, TKey>, ITransientDependency
        ...
        where TKey : IEquatable<TKey>
    {
        ...
        /// 
        /// </summary>
        protected IRepositoryGeneric<T, TKey> repository;

        /// <summary>
        /// 
        /// </summary>
        /// <param name="iRepository"></param>
        protected BaseServiceGeneric(IRepositoryGeneric<T, TKey> iRepository)
        {
        ...
        protected BaseServiceGeneric(IRepositoryGeneric<T, TKey> iRepository, IHttpContextAccessor accessor)
        {
            _accessor = accessor;
            repository = iRepository;
