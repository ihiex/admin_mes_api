...
namespace SunnyMES.Commons.Services
{
        ...
        where TKey : IEquatable<TKey>
    {
        ...
        {
            return repository.ExecSQLite(S_SQLite);
        }
        /// <summary>
        /// SQLite_Data_Table
        /// </summary>
        ...
        {
            return repository.SQLite_Data_Table(S_SQLite);
        }
        /// <summary>
        /// Data_Table
        /// </summary>
        ...
        {
            return repository.Data_Table(S_Sql);
        }
        /// <summary>
        /// Data_Set
        /// </summary>
        ...
        {
            return repository.Data_Set(S_Sql);
        }
        /// <summary>
        /// ExecSql
        /// </summary>
        ...
        {
            return repository.ExecSql(S_Sql);
        }
