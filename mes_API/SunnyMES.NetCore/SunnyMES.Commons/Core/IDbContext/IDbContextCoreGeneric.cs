...
namespace SunnyMES.Commons.IDbContext
{
    ...
    /// 上下文基础接口
    /// </summary>
    public interface IDbContextCoreGeneric : IDisposable
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        /// <returns></returns>
        int Delete<T, TKey>(TKey key) where T : EntityGeneric;
        ...
        /// <param name="key">主键值</param>
        /// <returns></returns>
        T Find<T, TKey>(TKey key) where T : EntityGeneric;
        /// <summary>
        /// 根据主键查询实体
        /// </summary>
        /// <typeparam name="T"></typeparam>
        ...
        /// <param name="key">主键值</param>
        /// <returns></returns>
        Task<T> FindAsync<T, TKey>(TKey key) where T : EntityGeneric;
        /// <summary>
        /// 根据条件查询实体，返回实体集合
        /// </summary>
        /// <typeparam name="T"></typeparam>
        ...
        /// <returns></returns>
        T GetByCompileQuery<T, TKey>(TKey id) where T : EntityGeneric;
        /// <summary>
        /// 根据主键查询返回一个实体，该方法是显式编译的查询
        /// </summary>
        /// <typeparam name="T"></typeparam>
        ...
        /// <param name="id">主键值</param>
        /// <returns></returns>
        Task<T> GetByCompileQueryAsync<T, TKey>(TKey id) where T : EntityGeneric;
        /// <summary>
