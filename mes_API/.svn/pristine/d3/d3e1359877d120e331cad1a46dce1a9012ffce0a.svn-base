...
{
    public class SC_mesSNFormatMapService : BaseServiceReport<string>, ISC_mesSNFormatMapService
    {
        private readonly ISC_mesSNFormatMapRepository _repository;
        private readonly ILogService _logService;

        public SC_mesSNFormatMapService(ISC_mesSNFormatMapRepository repository, ILogService logService) : base(repository)
        {
        ...
        {
            return await _repository.Insert(v_SC_mesSNFormatMap, trans);
        }
        ...
        {
            return await _repository.Update(v_SC_mesSNFormatMap, trans);
        }

        public async Task<string> Clone(SC_mesSNFormatMap v_SC_mesSNFormatMap, IDbTransaction trans = null)
        {
            return await _repository.Clone(v_SC_mesSNFormatMap, trans);
        }
        ...
        public async Task<PageResult<SC_mesSNFormatMapDto>> FindWithPagerMyAsync(SC_mesSNFormatMapSearch search)
        {
            ...
            List<SC_mesSNFormatMapDto> list = await _repository.FindWithPagerMyAsync(search, pagerInfo);
            ...
            PageResult<SC_mesSNFormatMapDto> pageResult = new PageResult<SC_mesSNFormatMapDto>
            {
