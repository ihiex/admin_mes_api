...
namespace SunnyMES.WebApi.Areas.Security.Controllers
{
    ...
    [ApiVersion("2.0")]
    public class JumpStationController : AreaApiControllerReport<IJumpStationServices, string>
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        /// <param name="_iService"></param>
        public JumpStationController(IJumpStationServices _iService) : base(_iService)
        {
            iService = _iService;
        }
        ...
        /// <param name="S_URL">URL</param>
        /// <returns></returns>
        [HttpGet("SetScanSN_JumpStation")]
        [YuebonAuthorize("")]
        [AllowAnonymousAttribute]
        public async Task<IActionResult> SetScanSN_JumpStation(string S_SN, string S_PartFamilyTypeID, string S_PartFamilyID,
            string S_PartID, string S_POID, string S_UnitStatus, string S_DefectID, string S_URL)
        {
            ...
            try
            {
                ...
                SetScanSNOutputDto List_Dyn = await iService.SetScanSN_JumpStation(S_SN, S_PartFamilyTypeID, S_PartFamilyID,
