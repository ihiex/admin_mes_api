...
{
    public class JumpStationServices : BaseServiceReport<string>, IJumpStationServices
    {
        private readonly IJumpStationRepository _repository;
        private readonly ILogService _logService;

        public JumpStationServices(IJumpStationRepository repository, ILogService logService) : base(repository)
        {
        ...
        {
            return await _repository.SetScanSN_JumpStation(S_SN, S_PartFamilyTypeID, S_PartFamilyID,
