...
namespace SunnyMES.Commons.Extensions
{
    /// <summary>
    ...
    public static class AppServiceCollectionExtensions
    {
        ...
        /// <param name="services"></param>
        /// <returns></returns>
        public static IServiceCollection AddDbContextCustom<IT, T>(this IServiceCollection services) where IT : IDbContextCoreCustom where T : BaseDbContext, IT
        {
            if (services == null) throw new ArgumentNullException(nameof(services));
        ...
        /// <param name="option">数据库上下文配置参数</param>
        /// <returns></returns>
        public static IServiceCollection AddDbContextCustom<IT, T>(this IServiceCollection services, DbContextOption option) where IT : IDbContextCoreCustom where T : BaseDbContext, IT
        {
            if (services == null) throw new ArgumentNullException(nameof(services));
            if (option == null) throw new ArgumentNullException(nameof(option));
            services.AddSingleton(option);
            return services.AddDbContextCustom<IT, T>(option);
        }
