...
namespace SunnyMES.Security.IRepositories
{
    ...
    public interface ISC_mesLabelFieldDefinitionRepository : IRepositoryReport<string>
    {
        ...
        Task<List<SC_mesLabelFieldDefinition>> FindWithPagerMyAsync(SC_mesLabelFieldDefinitionSearch search, PagerInfo info);
