...
namespace SunnyMES.WebApi.Areas.Security.Controllers
{
    ...
    [ApiVersion("3.0")]
    public class SC_mesUnitStateController : AreaApiControllerReport<ISC_IdDescService, string>
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        /// <param name="_iService"></param>
        public SC_mesUnitStateController(ISC_IdDescService _iService) : base(_iService)
        {
            iService = _iService;
        }
        ...
        public async Task<IActionResult> Insert(SC_IdDesc v_SC_IdDescDto)
        {
            ...
            try
            {
                ...
                string list = await iService.Insert(v_SC_IdDescDto, "mesUnitState", trans);
        ...
        public async Task<IActionResult> Delete(string Id)
        {
            ...
            try
            {
                ...
                List<TabVal> List_ConfInfo = await iService.GetConfInfo(P_Language, P_LineID, P_StationID, P_EmployeeID, P_CurrentLoginIP);
                IDbTransaction trans = null;
                string list = await iService.Delete(Id, "mesUnitState", trans);
        ...
        public async Task<IActionResult> Update(SC_IdDesc v_SC_IdDescDto)
        {
            ...
            try
            {
                ...
                List<TabVal> List_ConfInfo = await iService.GetConfInfo(P_Language, P_LineID, P_StationID, P_EmployeeID, P_CurrentLoginIP);
                IDbTransaction trans = null;
                string list = await iService.Update(v_SC_IdDescDto, "mesUnitState", trans);
        ...
        public async Task<IActionResult> Clone(SC_IdDesc v_SC_IdDescDto)
        {
            ...
            try
            {
                ...
                List<TabVal> List_ConfInfo = await iService.GetConfInfo(P_Language, P_LineID, P_StationID, P_EmployeeID, P_CurrentLoginIP);
                IDbTransaction trans = null;
                string list = await iService.Clone(v_SC_IdDescDto, "mesUnitState", trans);
            ...
            )
        {
            ...
            try
            {
                ...
                PageResult<SC_IdDesc> list = await iService.FindWithPagerSearchAsync(search, "mesUnitState");
