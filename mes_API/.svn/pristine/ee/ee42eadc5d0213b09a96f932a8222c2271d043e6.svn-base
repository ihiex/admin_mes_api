...
{
    /// <summary>
    ///  ScanUPC_PrintFGSN 可用接口
    /// </summary>
    [ApiController]
    [Route("api/Security/[controller]")]
    [ApiVersion("2.0")]
    public class ScanUPC_PrintFGSNController : AreaApiControllerReport<IScanUPC_PrintFGSNService, string>
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        /// <param name="_iService"></param>
        public ScanUPC_PrintFGSNController(IScanUPC_PrintFGSNService _iService) : base(_iService)
        {
            iService = _iService;
        }
