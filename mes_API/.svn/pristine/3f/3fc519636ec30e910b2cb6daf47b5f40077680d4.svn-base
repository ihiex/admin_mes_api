...
namespace SunnyMES.WebApi.SysConfig.Part
{
    ...
    [ApiVersion("3.0")]
    public class SC_luPartDetailDefController : AreaApiControllerCustom<SC_luPartDetailDef, SC_luPartDetailDef, SC_luPartDetailDef, ISC_luPartDetailDefServices, string>
    {
        public SC_luPartDetailDefController(ISC_luPartDetailDefServices _iService) : base(_iService)
        {
        ...
        [YuebonAuthorize("")]
        public override async  Task<IActionResult> UpdateAsync(SC_luPartDetailDef inInfo)
        {
