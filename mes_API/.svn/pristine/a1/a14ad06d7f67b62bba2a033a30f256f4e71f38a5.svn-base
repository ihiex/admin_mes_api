...
{
    /// <summary>
    ///  ScanFGSN_PrintUPC 可用接口
    /// </summary>
    [ApiController]
    [Route("api/Security/[controller]")]
    [ApiVersion("2.0")]
    public class ScanFGSN_PrintUPCController : AreaApiControllerReport<IScanFGSN_PrintUPCService, string>
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        /// <param name="_iService"></param>
        public ScanFGSN_PrintUPCController(IScanFGSN_PrintUPCService _iService) : base(_iService)
        {
            iService = _iService;
        }
