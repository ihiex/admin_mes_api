...
{
    public class ScanFGSN_PrintUPCService : BaseServiceReport<string>, IScanFGSN_PrintUPCService
    {
        private readonly IScanFGSN_PrintUPCRepository _repository;
        private readonly ILogService _logService;

        public ScanFGSN_PrintUPCService(IScanFGSN_PrintUPCRepository repository, ILogService logService) : base(repository)
        {
