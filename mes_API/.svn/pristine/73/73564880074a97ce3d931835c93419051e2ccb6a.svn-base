...
using System;
using System.IO;
using SunnyMES.WeChat.CommonService.CustomMessageHandler;
using SunnyMES.WeChat.CommonService.OpenTicket;

namespace SunnyMES.WeChat.CommonService.OpenMessageHandler
{
    /// <summary>
    /// 开放平台全网发布之前需要做的验证
    /// </summary>
