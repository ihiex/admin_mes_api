...
{
    public class ScanToolingPrintService : BaseServiceReport<string>, IScanToolingPrintService
    {
        private readonly IScanToolingPrintRepository _repository;
        private readonly ILogService _logService;

        public ScanToolingPrintService(IScanToolingPrintRepository repository, ILogService logService) : base(repository)
        {
