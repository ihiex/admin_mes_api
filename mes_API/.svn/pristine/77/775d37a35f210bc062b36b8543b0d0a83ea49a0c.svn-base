...
namespace SunnyMES.Security.IServices
{
    ...
    /// 定义服务接口
    /// </summary>
    public interface IBZhangService : IServiceGeneric<BZhang, BZhangOutputDto, string>
    {
        /// <summary>
        /// 获取app对象
        /// </summary>
        ...
        /// <returns></returns>
        BZhang GetB_Zhang(string appid, string secret);
        ...
        /// <param name="appid">应用ID</param>
        /// <returns></returns>
        BZhang GetB_Zhang(string appid);
        /// <summary>
        /// 
        /// </summary>
        /// <returns></returns>
