...
public class BoxPackageAutoServices : BaseCommonService<string>, IBoxPackageAutoServices
{
    private readonly IHttpContextAccessor accessor;
    private readonly IBoxPackageAutoRepository iRepository;

    public BoxPackageAutoServices(IBoxPackageAutoRepository iRepository) : base(iRepository)
    {
        this.iRepository = iRepository;
    }

    public BoxPackageAutoServices(IBoxPackageAutoRepository iRepository, IHttpContextAccessor accessor) : base(iRepository, accessor)
    {
        this.iRepository = iRepository;
